...
var LoadingView = React.createClass({
    ...
    render: function () {
        var svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="svg" x="0px" y="0px" width="150px" height="150px" viewBox="0 0 213.235 241.176" enable-background="new 0 0 213.235 241.176" xml:space="preserve" fill="#0057B8">'
            ...
            +'</svg>';
        return (
            <div class="svg svg-loading" dangerouslySetInnerHTML={{ __html: svg }}>
            </div>
        );
    }
});
